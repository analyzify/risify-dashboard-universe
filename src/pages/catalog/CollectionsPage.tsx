...
const initialData: TreeItem[] = [
  {
    ...
    expanded: true,
    children: [
      { title: "Dresses", children: [] },
      { title: "Tops", children: [] },
      { title: "Bottoms", children: [] },
      { title: "Outerwear", children: [] }
    ]
  },
  {
    title: "Men",
    ...
    children: [
      ...
      { title: "Pants", children: [] },
      { title: "Suits", children: [] },
      { title: "Outerwear", children: [] }
    ]
  },
  {
  ...
  },
  {
    ...
    expanded: true,
    children: [
      { title: "Living Room", children: [] },
      { title: "Bedroom", children: [] },
