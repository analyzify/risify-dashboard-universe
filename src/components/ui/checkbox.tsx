...
>(({ className, indeterminate, ...props }, ref) => {
  ...
  React.useEffect(() => {
    if (checkboxRef.current) {
      // Set the indeterminate property on the underlying input element
      if (typeof indeterminate === "boolean" && checkboxRef.current.dataset) {
        checkboxRef.current.dataset.indeterminate = String(indeterminate)
      }
    }
  }, [indeterminate])
